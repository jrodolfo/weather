...
public class JaxbWeatherService implements WeatherService {

    /**
     * The XML parsing is done using JAXB: the XML structure is loaded into
     * memory and some DOM methods are used to work with it. <br>
     * 
    ...
    public WeatherData getWeather(URL weatherDataURL) {
        ...
        try {
            jaxbContext = JAXBContext
                    .newInstance(com.jrodolfo.weather.model.jaxbgenerated.site.ObjectFactory.class);
